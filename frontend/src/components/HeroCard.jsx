...
const HeroCard = ({ orientation = 'horizontal', showActions = true, className = '' }) => {
  const classes = ['hero-content', 'hero-card']
  if (orientation === 'vertical') classes.push('hero-card-vertical')
    ...
    <div className={classes.join(' ')}>
      <div className="hero-left">
        ...
        <p className="hero-description">
          Graduated with a BS in Computer Science and certified in Python, with a focus on building efficient,
        ...
        {showActions && (
          <div className="hero-actions">
            ...
            <a
              href="https://linkedin.com/in/mujtabaalmas"
      ...
      <div className="hero-right">
        <HeroPortraitCard className={orientation === 'vertical' ? 'hero-portrait-vertical' : ''} />
      </div>
    </div>
  )
}
